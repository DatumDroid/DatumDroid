...
import com.datumdroid.app.ocr.CaptureActivity;

public class DatumDroidActivity extends Activity {
	public static final String PACKAGE_NAME = "com.datumdroid.app.ocr";
					...
					public void onClick(View v) {
						...
						if (searchTextBox.getText().toString().length() == 0) {
							Toast.makeText(DatumDroidActivity.this,
									R.string.null_search_term, Toast.LENGTH_SHORT).show();
