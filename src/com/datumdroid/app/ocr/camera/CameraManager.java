...
package com.datumdroid.app.ocr.camera;
...
import com.datumdroid.app.ocr.PlanarYUVLuminanceSource;
import com.datumdroid.app.ocr.PreferencesActivity;
...
////      // Save the flash state to SharedPreferences
////      SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
////      prefs.edit().putBoolean(PreferencesActivity.KEY_TOGGLE_LIGHT, false).commit();
////      
//    }
//  }
